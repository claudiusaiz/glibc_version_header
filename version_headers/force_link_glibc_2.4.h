...
__asm__(".symver getpublickey,getpublickey@GLIBC_2.2.5");
...
__asm__(".symver getsecretkey,getsecretkey@GLIBC_2.2.5");
...
__asm__(".symver key_decryptsession,key_decryptsession@GLIBC_2.2.5");
__asm__(".symver key_decryptsession_pk,key_decryptsession_pk@GLIBC_2.2.5");
__asm__(".symver key_encryptsession,key_encryptsession@GLIBC_2.2.5");
__asm__(".symver key_encryptsession_pk,key_encryptsession_pk@GLIBC_2.2.5");
__asm__(".symver key_gendes,key_gendes@GLIBC_2.2.5");
__asm__(".symver key_get_conv,key_get_conv@GLIBC_2.2.5");
__asm__(".symver key_secretkey_is_set,key_secretkey_is_set@GLIBC_2.2.5");
__asm__(".symver key_setnet,key_setnet@GLIBC_2.2.5");
__asm__(".symver key_setsecret,key_setsecret@GLIBC_2.2.5");
...
__asm__(".symver netname2host,netname2host@GLIBC_2.2.5");
__asm__(".symver netname2user,netname2user@GLIBC_2.2.5");
...
__asm__(".symver passwd2des,passwd2des@GLIBC_2.2.5");
...
__asm__(".symver pmap_getmaps,pmap_getmaps@GLIBC_2.2.5");
__asm__(".symver pmap_getport,pmap_getport@GLIBC_2.2.5");
__asm__(".symver pmap_rmtcall,pmap_rmtcall@GLIBC_2.2.5");
__asm__(".symver pmap_set,pmap_set@GLIBC_2.2.5");
__asm__(".symver pmap_unset,pmap_unset@GLIBC_2.2.5");
...
__asm__(".symver registerrpc,registerrpc@GLIBC_2.2.5");
...
__asm__(".symver rtime,rtime@GLIBC_2.2.5");
...
__asm__(".symver svc_exit,svc_exit@GLIBC_2.2.5");
__asm__(".symver svc_fdset,svc_fdset@GLIBC_2.2.5");
__asm__(".symver svc_getreq,svc_getreq@GLIBC_2.2.5");
__asm__(".symver svc_getreq_common,svc_getreq_common@GLIBC_2.2.5");
__asm__(".symver svc_getreq_poll,svc_getreq_poll@GLIBC_2.2.5");
__asm__(".symver svc_getreqset,svc_getreqset@GLIBC_2.2.5");
...
__asm__(".symver svc_run,svc_run@GLIBC_2.2.5");
__asm__(".symver svc_sendreply,svc_sendreply@GLIBC_2.2.5");
__asm__(".symver svc_unregister,svc_unregister@GLIBC_2.2.5");
__asm__(".symver svcauthdes_stats,svcauthdes_stats@GLIBC_2.2.5");
__asm__(".symver svcerr_auth,svcerr_auth@GLIBC_2.2.5");
__asm__(".symver svcerr_decode,svcerr_decode@GLIBC_2.2.5");
__asm__(".symver svcerr_noproc,svcerr_noproc@GLIBC_2.2.5");
__asm__(".symver svcerr_noprog,svcerr_noprog@GLIBC_2.2.5");
__asm__(".symver svcerr_progvers,svcerr_progvers@GLIBC_2.2.5");
__asm__(".symver svcerr_systemerr,svcerr_systemerr@GLIBC_2.2.5");
__asm__(".symver svcerr_weakauth,svcerr_weakauth@GLIBC_2.2.5");
__asm__(".symver svcfd_create,svcfd_create@GLIBC_2.2.5");
__asm__(".symver svcraw_create,svcraw_create@GLIBC_2.2.5");
__asm__(".symver svctcp_create,svctcp_create@GLIBC_2.2.5");
__asm__(".symver svcudp_bufcreate,svcudp_bufcreate@GLIBC_2.2.5");
__asm__(".symver svcudp_create,svcudp_create@GLIBC_2.2.5");
__asm__(".symver svcudp_enablecache,svcudp_enablecache@GLIBC_2.2.5");
__asm__(".symver svcunix_create,svcunix_create@GLIBC_2.2.5");
__asm__(".symver svcunixfd_create,svcunixfd_create@GLIBC_2.2.5");
...
__asm__(".symver user2netname,user2netname@GLIBC_2.2.5");
...
__asm__(".symver xdr_accepted_reply,xdr_accepted_reply@GLIBC_2.2.5");
__asm__(".symver xdr_array,xdr_array@GLIBC_2.2.5");
__asm__(".symver xdr_authdes_cred,xdr_authdes_cred@GLIBC_2.2.5");
__asm__(".symver xdr_authdes_verf,xdr_authdes_verf@GLIBC_2.2.5");
__asm__(".symver xdr_authunix_parms,xdr_authunix_parms@GLIBC_2.2.5");
__asm__(".symver xdr_bool,xdr_bool@GLIBC_2.2.5");
__asm__(".symver xdr_bytes,xdr_bytes@GLIBC_2.2.5");
__asm__(".symver xdr_callhdr,xdr_callhdr@GLIBC_2.2.5");
__asm__(".symver xdr_callmsg,xdr_callmsg@GLIBC_2.2.5");
__asm__(".symver xdr_cback_data,xdr_cback_data@GLIBC_2.2.5");
__asm__(".symver xdr_char,xdr_char@GLIBC_2.2.5");
__asm__(".symver xdr_cryptkeyarg,xdr_cryptkeyarg@GLIBC_2.2.5");
__asm__(".symver xdr_cryptkeyarg2,xdr_cryptkeyarg2@GLIBC_2.2.5");
__asm__(".symver xdr_cryptkeyres,xdr_cryptkeyres@GLIBC_2.2.5");
__asm__(".symver xdr_des_block,xdr_des_block@GLIBC_2.2.5");
__asm__(".symver xdr_domainname,xdr_domainname@GLIBC_2.2.5");
__asm__(".symver xdr_double,xdr_double@GLIBC_2.2.5");
__asm__(".symver xdr_enum,xdr_enum@GLIBC_2.2.5");
__asm__(".symver xdr_float,xdr_float@GLIBC_2.2.5");
__asm__(".symver xdr_free,xdr_free@GLIBC_2.2.5");
__asm__(".symver xdr_getcredres,xdr_getcredres@GLIBC_2.2.5");
__asm__(".symver xdr_hyper,xdr_hyper@GLIBC_2.2.5");
__asm__(".symver xdr_int,xdr_int@GLIBC_2.2.5");
__asm__(".symver xdr_int16_t,xdr_int16_t@GLIBC_2.2.5");
__asm__(".symver xdr_int32_t,xdr_int32_t@GLIBC_2.2.5");
__asm__(".symver xdr_int64_t,xdr_int64_t@GLIBC_2.2.5");
__asm__(".symver xdr_int8_t,xdr_int8_t@GLIBC_2.2.5");
__asm__(".symver xdr_key_netstarg,xdr_key_netstarg@GLIBC_2.2.5");
__asm__(".symver xdr_key_netstres,xdr_key_netstres@GLIBC_2.2.5");
__asm__(".symver xdr_keybuf,xdr_keybuf@GLIBC_2.2.5");
__asm__(".symver xdr_keydat,xdr_keydat@GLIBC_2.2.5");
__asm__(".symver xdr_keystatus,xdr_keystatus@GLIBC_2.2.5");
__asm__(".symver xdr_long,xdr_long@GLIBC_2.2.5");
__asm__(".symver xdr_longlong_t,xdr_longlong_t@GLIBC_2.2.5");
__asm__(".symver xdr_mapname,xdr_mapname@GLIBC_2.2.5");
__asm__(".symver xdr_netnamestr,xdr_netnamestr@GLIBC_2.2.5");
...
__asm__(".symver xdr_opaque_auth,xdr_opaque_auth@GLIBC_2.2.5");
__asm__(".symver xdr_peername,xdr_peername@GLIBC_2.2.5");
__asm__(".symver xdr_pmap,xdr_pmap@GLIBC_2.2.5");
__asm__(".symver xdr_pmaplist,xdr_pmaplist@GLIBC_2.2.5");
__asm__(".symver xdr_pointer,xdr_pointer@GLIBC_2.2.5");
__asm__(".symver xdr_quad_t,xdr_quad_t@GLIBC_2.3.4");
__asm__(".symver xdr_reference,xdr_reference@GLIBC_2.2.5");
__asm__(".symver xdr_rejected_reply,xdr_rejected_reply@GLIBC_2.2.5");
__asm__(".symver xdr_replymsg,xdr_replymsg@GLIBC_2.2.5");
__asm__(".symver xdr_rmtcall_args,xdr_rmtcall_args@GLIBC_2.2.5");
__asm__(".symver xdr_rmtcallres,xdr_rmtcallres@GLIBC_2.2.5");
__asm__(".symver xdr_short,xdr_short@GLIBC_2.2.5");
...
__asm__(".symver xdr_u_hyper,xdr_u_hyper@GLIBC_2.2.5");
__asm__(".symver xdr_u_int,xdr_u_int@GLIBC_2.2.5");
__asm__(".symver xdr_u_long,xdr_u_long@GLIBC_2.2.5");
__asm__(".symver xdr_u_longlong_t,xdr_u_longlong_t@GLIBC_2.2.5");
__asm__(".symver xdr_u_quad_t,xdr_u_quad_t@GLIBC_2.3.4");
__asm__(".symver xdr_u_short,xdr_u_short@GLIBC_2.2.5");
__asm__(".symver xdr_uint16_t,xdr_uint16_t@GLIBC_2.2.5");
__asm__(".symver xdr_uint32_t,xdr_uint32_t@GLIBC_2.2.5");
__asm__(".symver xdr_uint64_t,xdr_uint64_t@GLIBC_2.2.5");
__asm__(".symver xdr_uint8_t,xdr_uint8_t@GLIBC_2.2.5");
__asm__(".symver xdr_union,xdr_union@GLIBC_2.2.5");
__asm__(".symver xdr_unixcred,xdr_unixcred@GLIBC_2.2.5");
__asm__(".symver xdr_valdat,xdr_valdat@GLIBC_2.2.5");
__asm__(".symver xdr_vector,xdr_vector@GLIBC_2.2.5");
__asm__(".symver xdr_void,xdr_void@GLIBC_2.2.5");
__asm__(".symver xdr_wrapstring,xdr_wrapstring@GLIBC_2.2.5");
...
__asm__(".symver xdrrec_create,xdrrec_create@GLIBC_2.2.5");
__asm__(".symver xdrrec_endofrecord,xdrrec_endofrecord@GLIBC_2.2.5");
__asm__(".symver xdrrec_eof,xdrrec_eof@GLIBC_2.2.5");
__asm__(".symver xdrrec_skiprecord,xdrrec_skiprecord@GLIBC_2.2.5");
__asm__(".symver xdrstdio_create,xdrstdio_create@GLIBC_2.2.5");
__asm__(".symver xencrypt,xencrypt@GLIBC_2.2.5");
__asm__(".symver xprt_register,xprt_register@GLIBC_2.2.5");
...
// copied from 2.5
__asm__(".symver _ZGVbN2v_cos,_ZGVbN2v_cos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN2v_exp,_ZGVbN2v_exp@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN2v_log,_ZGVbN2v_log@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN2v_sin,_ZGVbN2v_sin@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN2vv_pow,_ZGVbN2vv_pow@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN2vvv_sincos,_ZGVbN2vvv_sincos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4v_cosf,_ZGVbN4v_cosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4v_expf,_ZGVbN4v_expf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4v_logf,_ZGVbN4v_logf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4v_sinf,_ZGVbN4v_sinf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4vv_powf,_ZGVbN4vv_powf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVbN4vvv_sincosf,_ZGVbN4vvv_sincosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4v_cos,_ZGVcN4v_cos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4v_exp,_ZGVcN4v_exp@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4v_log,_ZGVcN4v_log@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4v_sin,_ZGVcN4v_sin@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4vv_pow,_ZGVcN4vv_pow@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN4vvv_sincos,_ZGVcN4vvv_sincos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8v_cosf,_ZGVcN8v_cosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8v_expf,_ZGVcN8v_expf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8v_logf,_ZGVcN8v_logf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8v_sinf,_ZGVcN8v_sinf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8vv_powf,_ZGVcN8vv_powf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVcN8vvv_sincosf,_ZGVcN8vvv_sincosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4v_cos,_ZGVdN4v_cos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4v_exp,_ZGVdN4v_exp@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4v_log,_ZGVdN4v_log@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4v_sin,_ZGVdN4v_sin@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4vv_pow,_ZGVdN4vv_pow@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN4vvv_sincos,_ZGVdN4vvv_sincos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8v_cosf,_ZGVdN8v_cosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8v_expf,_ZGVdN8v_expf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8v_logf,_ZGVdN8v_logf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8v_sinf,_ZGVdN8v_sinf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8vv_powf,_ZGVdN8vv_powf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVdN8vvv_sincosf,_ZGVdN8vvv_sincosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16v_cosf,_ZGVeN16v_cosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16v_expf,_ZGVeN16v_expf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16v_logf,_ZGVeN16v_logf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16v_sinf,_ZGVeN16v_sinf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16vv_powf,_ZGVeN16vv_powf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN16vvv_sincosf,_ZGVeN16vvv_sincosf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8v_cos,_ZGVeN8v_cos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8v_exp,_ZGVeN8v_exp@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8v_log,_ZGVeN8v_log@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8v_sin,_ZGVeN8v_sin@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8vv_pow,_ZGVeN8vv_pow@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver _ZGVeN8vvv_sincos,_ZGVeN8vvv_sincos@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __cxa_at_quick_exit,__cxa_at_quick_exit@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __dprintf_chk,__dprintf_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __fread_chk,__fread_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __fread_unlocked_chk,__fread_unlocked_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __isoc99_fscanf,__isoc99_fscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_fwscanf,__isoc99_fwscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_scanf,__isoc99_scanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_sscanf,__isoc99_sscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_swscanf,__isoc99_swscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_vfscanf,__isoc99_vfscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_vfwscanf,__isoc99_vfwscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __isoc99_vswscanf,__isoc99_vswscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_vwscanf,__isoc99_vwscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __isoc99_wscanf,__isoc99_wscanf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __mq_open_2,__mq_open_2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __obstack_printf_chk,__obstack_printf_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __open_2,__open_2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __openat64_2,__openat64_2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __openat_2,__openat_2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __poll_chk,__poll_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __posix_getopt,__posix_getopt@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __sched_cpualloc,__sched_cpualloc@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __sched_cpucount,__sched_cpucount@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __sched_cpufree,__sched_cpufree@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver __vasprintf_chk,__vasprintf_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver __vdprintf_chk,__vdprintf_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver accept4,accept4@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver dup3,dup3@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver endsgent,endsgent@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver epoll_create1,epoll_create1@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver epoll_pwait,epoll_pwait@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver eventfd_read,eventfd_read@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver eventfd_write,eventfd_write@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver fallocate,fallocate@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver fgetsgent,fgetsgent@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver fgetsgent_r,fgetsgent_r@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver futimens,futimens@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver getsgent_r,getsgent_r@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver getsgnam,getsgnam@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver getsgnam_r,getsgnam_r@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver inotify_init1,inotify_init1@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver malloc_info,malloc_info@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver mkostemp,mkostemp@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver ns_datetosecs,ns_datetosecs@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_format_ttl,ns_format_ttl@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_get16,ns_get16@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_get32,ns_get32@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_initparse,ns_initparse@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_makecanon,ns_makecanon@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_msg_getflag,ns_msg_getflag@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_compress,ns_name_compress@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_ntol,ns_name_ntol@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_ntop,ns_name_ntop@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_pack,ns_name_pack@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_pton,ns_name_pton@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_rollback,ns_name_rollback@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_skip,ns_name_skip@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_uncompress,ns_name_uncompress@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_name_unpack,ns_name_unpack@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_parse_ttl,ns_parse_ttl@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_parserr,ns_parserr@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_put16,ns_put16@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_put32,ns_put32@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_samedomain,ns_samedomain@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_samename,ns_samename@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_skiprr,ns_skiprr@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_sprintrr,ns_sprintrr@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_sprintrrf,ns_sprintrrf@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver ns_subdomain,ns_subdomain@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver pipe2,pipe2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver preadv64,preadv64@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver psiginfo,psiginfo@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver putsgent,putsgent@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver pwritev,pwritev@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver pwritev2,pwritev2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver pwritev64,pwritev64@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver pwritev64v2,pwritev64v2@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver qsort_r,qsort_r@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver quick_exit,quick_exit@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver register_printf_modifier,register_printf_modifier@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver register_printf_specifier,register_printf_specifier@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver register_printf_type,register_printf_type@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver sched_getcpu,sched_getcpu@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver setsgent,setsgent@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver sgetsgent,sgetsgent@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver sgetsgent_r,sgetsgent_r@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver signalfd,signalfd@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver strerror_l,strerror_l@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver sync_file_range,sync_file_range@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver timerfd_create,timerfd_create@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver timerfd_gettime,timerfd_gettime@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver timerfd_settime,timerfd_settime@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
__asm__(".symver utimensat,utimensat@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
...
// added in 2.5
__asm__(".symver __readlinkat_chk,__readlinkat_chk@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_append,inet6_opt_append@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_find,inet6_opt_find@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_finish,inet6_opt_finish@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_get_val,inet6_opt_get_val@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_init,inet6_opt_init@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_next,inet6_opt_next@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_opt_set_val,inet6_opt_set_val@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_add,inet6_rth_add@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_getaddr,inet6_rth_getaddr@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_init,inet6_rth_init@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_reverse,inet6_rth_reverse@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_segments,inet6_rth_segments@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver inet6_rth_space,inet6_rth_space@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver splice,splice@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver tee,tee@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
__asm__(".symver vmsplice,vmsplice@GLIBC_WRAP_ERROR_SYMBOL_NOT_PRESENT_IN_REQUESTED_VERSION");
#endif
